    ...
    SetupTurret = function(self)
        ...
        if yawBone and pitchBone and muzzleBone then
            if bp.TurretDualManipulators then
                ...
                if EntityCategoryContains(categories.STRUCTURE, self.unit) and not EntityCategoryContains(categories.EQSTRUCTRESETAIM, self.unit) then -- fixed in equilibrium - now you can add a category to a structure to ignore this
