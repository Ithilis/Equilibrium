...
Unit_Description_0155="Strategic Missile Submarine. Armed with long-range tactical missiles, powerful torpedoes, and can build and launch strategic EMP weapons that stuns enemy units for long time on huge area but cause less damage, consider use navy on time while are enemy fore stunned. Equipped with a personal stealth generator." --Ithilis
...
Unit_Description_0429="Increase ACU health and regeneration. Emits a field which support nearby allies units by increase max hp and additional regeneration." --Ithilis
Unit_Description_0430="Increase ACU health and regeneration. Emits a bigger field which support nearby allies units by increase max hp and additional regeneration." --Ithilis
