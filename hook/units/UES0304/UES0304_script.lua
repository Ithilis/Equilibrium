...
UES0304 = Class(TSubUnit) { --since we change weapons in here, i didnt find a way to hook them properly.
    ...
    Weapons = {
        CruiseMissiles = Class(TIFCruiseMissileLauncherSub) {
            ...
            CreateProjectileAtMuzzle = function(self, muzzle)
                ...
                local proj = TIFCruiseMissileLauncherSub.CreateProjectileAtMuzzle(self, muzzle)
                local data = {
