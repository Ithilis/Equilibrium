...
local settings = {
    ...
    textLines = {
        ...
        "2. Submarine warfare has been remade: Subs now counter suface ships; Sub Hunters counter subs; and surface ships counter sub hunters!",       
        "3. Mass storages are cheaper, provide less adjacency, and any mass stored in them is lost when they are destroyed.",
