...
--EQ: this is disgusting but just hooking this doesnt avoid the issue.
--because the base game put in some dangerous code, if you hook defaultweapons with stuff, explosions happen.
--and you cant just unhook it, you need to remove the actual base code which needs a shadow.
